...
{
    public class AmazonSnsSendEmailNotificationHandler : INotificationHandler<SendEmailNotificationCommand>
    {
        private readonly IUserRepository _userRepository;
        private readonly INotificationRepository _notificationRepository;
        private readonly IAmazonSnsEmailNotificationService _emailNotificationService;
        ...
        private readonly string ServiceName = "AmazonSnsEmailNotificationService";
        private readonly string NotificationType = "Email";

        public AmazonSnsSendEmailNotificationHandler(
            IUserRepository userRepository,
            INotificationRepository notificationRepository,
            IAmazonSnsEmailNotificationService emailNotificationService,
