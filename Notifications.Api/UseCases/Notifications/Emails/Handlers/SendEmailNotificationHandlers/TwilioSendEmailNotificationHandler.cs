...
{
    public class TwilioSendEmailNotificationHandler : INotificationHandler<SendEmailNotificationCommand>
    {
        private readonly IUserRepository _userRepository;
        private readonly INotificationRepository _notificationRepository;
        private readonly ITwilioEmailNotificationService _emailNotificationService;
        ...
        private readonly string ServiceName = "TwilioEmailNotificationService";
        private readonly string NotificationType = "Email";

        public TwilioSendEmailNotificationHandler(
            IUserRepository userRepository,
            INotificationRepository notificationRepository,
            ITwilioEmailNotificationService emailNotificationService,
