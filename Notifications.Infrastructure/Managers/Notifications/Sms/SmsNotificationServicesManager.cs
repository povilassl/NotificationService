...
namespace Notifications.Infrastructure.Managers.Notifications.Sms
{
    public class SmsNotificationServicesManager : NotificationServicesManager, ISmsNotificationServicesManager
    {
        private readonly NotificationServicesSettings _settings;

        public SmsNotificationServicesManager(IOptions<NotificationServicesSettings> options)
        {
        ...
        {
            var activeService = _settings.SmsNotificationServices
            ...
            var fallbackService = _settings.SmsNotificationServices
                .Where(e => e.IsActive)
                .OrderBy(e => e.Priority)
                .FirstOrDefault();
